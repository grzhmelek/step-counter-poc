...
import com.example.stepcounterpoc.BuildConfig
import com.example.stepcounterpoc.databinding.FragmentGoogleFitBinding
import com.example.stepcounterpoc.ui.utils.FitActionRequestCode
...
class GoogleFitFragment : Fragment() {
    ...
    companion object {
        private val TAG = GoogleFitFragment::class.simpleName
    }

    private lateinit var binding: FragmentGoogleFitBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentGoogleFitBinding.inflate(inflater)

        viewModel = ViewModelProvider(this)[GoogleFitViewModel::class.java]
        ...
        Fitness.getRecordingClient(requireContext(), getGoogleAccount())
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    viewModel.setValues("Successfully subscribed!")
                } else {
    ...
    private fun readData() {
        Fitness.getHistoryClient(requireActivity(), getGoogleAccount())
            ...
            .addOnSuccessListener { dataSet ->
                ...
                viewModel.setValues("Total steps: $total")
            }
